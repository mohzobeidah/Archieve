...
namespace Archieve.DataAccess.Migrations
{
    ...
    [Migration("20200622120404_22062020_ibrahim")]
    partial class _22062020_ibrahim
    {
            ...
            modelBuilder.Entity("Archieve.DatabaseLayer.Models.Classification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertDate = new DateTime(2020, 6, 22, 15, 4, 3, 962, DateTimeKind.Local).AddTicks(3557),
                            IsDelete = false,
                            UpdateDate = new DateTime(2020, 6, 22, 15, 4, 3, 962, DateTimeKind.Local).AddTicks(4435)
                        });
                });
            ...
            modelBuilder.Entity("Archieve.DatabaseLayer.Models.PostType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertDate = new DateTime(2020, 6, 22, 15, 4, 3, 962, DateTimeKind.Local).AddTicks(9249),
                            IsDelete = false,
                            PostName = "دوليddd",
                            UpdateDate = new DateTime(2020, 6, 22, 15, 4, 3, 962, DateTimeKind.Local).AddTicks(9979)
                        });
                });
            ...
            modelBuilder.Entity("Archieve.DatabaseLayer.Models.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertDate = new DateTime(2020, 6, 22, 15, 4, 3, 958, DateTimeKind.Local).AddTicks(8263),
                            IsDelete = false,
                            SecurityName = "سري",
                            UpdateDate = new DateTime(2020, 6, 22, 15, 4, 3, 961, DateTimeKind.Local).AddTicks(8914)
                        });
                });
            ...
            modelBuilder.Entity("Archieve.DatabaseLayer.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertDate = new DateTime(2020, 6, 22, 15, 4, 3, 963, DateTimeKind.Local).AddTicks(8986),
                            IsDelete = false,
                            StatusName = "دوليddd",
                            UpdateDate = new DateTime(2020, 6, 22, 15, 4, 3, 963, DateTimeKind.Local).AddTicks(9473)
                        });
                });
